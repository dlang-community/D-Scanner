...
the given source file(s), the source(s) contained in the given folder(s), or the source(s) contained in the current working directory (when nothing is supplied).
